...
if(isset($_POST['register']))
{
    ...
    $employee_id=$_POST['employee_id'];
	  ...
	  $query="insert into mst_projects(id,name,user_ids,customer_id,status,start_date,end_date,is_active,is_removed)
       values('','$name','$employee','$customer','$status', '$start_date', '$end_date',true,false)";
echo $query ;
                        ...
                        <!-- <h5>Project Details</h5> -->
                                ...
                                <h5>Customer</h5>
                                    ...
                                    <option value="Select You Blood Group">---------Select Customer---------</option>
                                        <?php
                                            ...
                                            echo '<option value="'.$row['id'].'" text-align="center">'.$row['name'].'</option>';
                                            }
                                    ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <h5>Engineers</h5>
                                        <div class="form-floating mb-3 mb-md-0">
                                            <select name="employee" class="form-control" muliple>
                                            <option value="Select Engineers">---------Select Engineers---------</option>
                                            <?php
